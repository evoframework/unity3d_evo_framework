...
namespace Evo
{
    ...
    {
        Dictionary<string, T> _list = new Dictionary<string, T>();
        ...
        {
            get { return _list[index.ToString()]; }
            set { _list[index.ToString()] = value; }
        }
        #endregion
    }
}
